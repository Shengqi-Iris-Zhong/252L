...
par_test<-function(resp) {
    ...
    c(r,2*r/(1+r)) #r: correlation of the observed halves; adjusted for split half size
}
```
...
1000 times of split halves (but cronbach's alpha is only 1 value)
...
Those don't meet the parallel test form requirements. (don't have same level of difficulty)
